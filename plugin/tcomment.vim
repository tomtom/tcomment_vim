...
if (g:tcommentMapLeaderOp1 != '')
    ...
    for s:i in range(1, 9)
        exec 'nnoremap <silent> '. g:tcommentMapLeaderOp1 . s:i .'c :let w:tcommentPos = getpos(".") \| call tcomment#SetOption("count", '. s:i .') \| set opfunc=tcomment#OperatorAnyway<cr>g@'
    endfor
    unlet s:i
