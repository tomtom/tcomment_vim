...
call tcomment#type#Define('c_block',          g:tcommentBlockC   )
call tcomment#type#Define('c_inline',         g:tcommentInlineC  )
...
call tcomment#type#Define('cpp_block',        g:tcommentBlockC   )
call tcomment#type#Define('cpp_inline',       g:tcommentInlineC  )
call tcomment#type#Define('cram',             {'col': 1, 'commentstring': '# %s' })
call tcomment#type#Define('crontab',          '# %s'             )
call tcomment#type#Define('cs',               '// %s'            )
call tcomment#type#Define('cs_block',         g:tcommentBlockC   )
call tcomment#type#Define('cs_inline',        g:tcommentInlineC  )
call tcomment#type#Define('css',              '/* %s */'         )
call tcomment#type#Define('css_block',        g:tcommentBlockC   )
call tcomment#type#Define('css_inline',       g:tcommentInlineC  )
...
call tcomment#type#Define('docbk',            g:tcommentInlineXML)
call tcomment#type#Define('docbk_block',      g:tcommentBlockXML )
call tcomment#type#Define('docbk_inline',     g:tcommentInlineXML)
...
call tcomment#type#Define('go_block',         g:tcommentBlockC   )
call tcomment#type#Define('go_inline',        g:tcommentInlineC  )
call tcomment#type#Define('groovy',           tcomment#GetLineC('// %s'))
call tcomment#type#Define('groovy_block',     g:tcommentBlockC   )
call tcomment#type#Define('groovy_doc_block', g:tcommentBlockC2  )
call tcomment#type#Define('groovy_inline',    g:tcommentInlineC  )
...
call tcomment#type#Define('html',             g:tcommentInlineXML)
call tcomment#type#Define('html_block',       g:tcommentBlockXML )
call tcomment#type#Define('html_inline',      g:tcommentInlineXML)
...
call tcomment#type#Define('java_block',       g:tcommentBlockC   )
call tcomment#type#Define('java_doc_block',   g:tcommentBlockC2  )
call tcomment#type#Define('java_inline',      g:tcommentInlineC  )
call tcomment#type#Define('javascript',       tcomment#GetLineC('// %s'))
call tcomment#type#Define('javascript_block', g:tcommentBlockC   )
call tcomment#type#Define('javascript_inline', g:tcommentInlineC )
...
call tcomment#type#Define('liquid',           g:tcommentInlineXML)
call tcomment#type#Define('liquid_block',     g:tcommentBlockXML )
call tcomment#type#Define('liquid_inline',    g:tcommentInlineXML)
...
call tcomment#type#Define('msidl_block',      g:tcommentBlockC   )
...
call tcomment#type#Define('objc_block',       g:tcommentBlockC   )
call tcomment#type#Define('objc_inline',      g:tcommentInlineC  )
...
call tcomment#type#Define('php_2_block',      g:tcommentBlockC2  )
call tcomment#type#Define('php_block',        g:tcommentBlockC   )
call tcomment#type#Define('php_inline',       g:tcommentInlineC  )
...
call tcomment#type#Define('rust_block',       g:tcommentBlockC   )
call tcomment#type#Define('rust_inline',      g:tcommentInlineC  )
...
call tcomment#type#Define('scala_block',      g:tcommentBlockC   )
call tcomment#type#Define('scala_inline',     g:tcommentInlineC  )
call tcomment#type#Define('scheme',           '; %s'             )
call tcomment#type#Define('scheme_block',     '#|%s|#'           )
call tcomment#type#Define('scss',             '// %s'            )
call tcomment#type#Define('scss_block',       g:tcommentBlockC   )
call tcomment#type#Define('scss_inline',      g:tcommentInlineC  )
call tcomment#type#Define('sed',              '# %s'             )
call tcomment#type#Define('sgml',             g:tcommentInlineXML)
call tcomment#type#Define('sgml_block',       g:tcommentBlockXML )
call tcomment#type#Define('sgml_inline',      g:tcommentInlineXML)
...
call tcomment#type#Define('solidity_block',   g:tcommentBlockC)
call tcomment#type#Define('solidity_inline',  g:tcommentInlineC)
...
call tcomment#type#Define('typescript_block', g:tcommentBlockC   )
call tcomment#type#Define('typescript_inline', g:tcommentInlineC )
...
call tcomment#type#Define('verilog_inline',   g:tcommentInlineC  )
call tcomment#type#Define('verilog_block',    g:tcommentBlockC   )
call tcomment#type#Define('verilog_systemverilog',       '// %s' )
call tcomment#type#Define('verilog_systemverilog_block', g:tcommentBlockC)
call tcomment#type#Define('verilog_systemverilog_inline', g:tcommentInlineC)
...
call tcomment#type#Define('xml',              g:tcommentInlineXML)
call tcomment#type#Define('xml_block',        g:tcommentBlockXML )
call tcomment#type#Define('xml_inline',       g:tcommentInlineXML)
call tcomment#type#Define('xs',               g:tcommentInlineC  )
call tcomment#type#Define('xs_block',         g:tcommentBlockC   )
call tcomment#type#Define('xslt',             g:tcommentInlineXML)
call tcomment#type#Define('xslt_block',       g:tcommentBlockXML )
call tcomment#type#Define('xslt_inline',      g:tcommentInlineXML)
